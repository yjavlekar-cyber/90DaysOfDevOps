...
What I Learned*
First thing i learned that how to create and ec2 instance and how to connect it through ssh.
then learned how to update and install services.
how to check their status.
also did learn how to directly extract the logs into the new log file.
